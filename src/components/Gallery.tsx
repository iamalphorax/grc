...
// Heuristic categorization (without seeing the actual contents we distribute evenly)
const categorized = CLEANING_IMAGES.map((src, i) => ({
  src,
  category: i % 3 === 0 ? 'Living Spaces' : i % 3 === 1 ? 'Kitchens & Baths' : 'Detail Work',
  label: ['Spotless Living Area', 'Pristine Kitchen', 'Bathroom Refresh', 'Detail Cleaning', 'Move-In Ready', 'Deep Clean Result'][i % 6]
}));
